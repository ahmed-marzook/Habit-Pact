...
public record HabitResponse(
        ...
        @Schema(
                description = "Frequency configuration of the habit",
        ...
        @Schema(
                description = "Indicates if the habit is archived",
                example = "false"
        )
        boolean archived,

        @Schema(
                description = "Current streak information for the habit",
                implementation = Streak.class
        )
        Streak streak,

        @Schema(
                description = "Reminder settings for the habit",
                implementation = Reminder.class
        )
        Reminder reminder,
